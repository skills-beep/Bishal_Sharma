      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="bg-card/60 backdrop-blur-xl border-border/50 hover:border-purple-400/30 transition-all duration-300">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-card-foreground">Let's Connect</CardTitle>
              ...
              <CardContent className="space-y-4">
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center gap-4 p-3 rounded-lg bg-muted/20 hover:bg-muted/40 transition-colors group">
                      ...
                      <div className="flex-1">
                        ...
                        <a 
                          href={info.link}
                          className="text-card-foreground font-medium hover:text-purple-400 transition-colors"
                        >
                          {info.value}
                        </a>
                      </div>
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        ...
                        className={`p-3 rounded-lg bg-muted hover:bg-muted/80 text-muted-foreground ${social.color} transition-all duration-300 hover:scale-110`}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="bg-muted/20 border-border focus:border-purple-400 transition-colors"
                        required
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      className="bg-muted/20 border-border focus:border-purple-400 transition-colors min-h-[120px] resize-none"
                      required
                    />
                  </div>
        ...
        <div className="text-center">
          <div className="inline-flex items-center space-x-2 px-6 py-3 rounded-full bg-muted/20 border border-border backdrop-blur-sm">
