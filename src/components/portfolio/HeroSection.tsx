  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <Code className="absolute top-20 left-10 w-8 h-8 text-violet-400/40 animate-float" />
        <Sparkles className="absolute top-40 right-20 w-6 h-6 text-rose-400/40 animate-float-random" />
        <Code className="absolute bottom-32 left-1/4 w-6 h-6 text-sky-400/40 animate-float-slow" />
        <Sparkles className="absolute bottom-20 right-1/3 w-8 h-8 text-purple-400/40 animate-float-horizontal" />
      </div>

      <div className="max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          
          {/* Content - Enhanced with better animations and colors */}
          <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
            <div className="animate-fade-in">
              <p className="text-lg text-slate-400 mb-4 transform transition-all duration-700 hover:text-violet-400 hover:scale-105">Hi there, I'm</p>
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 transform transition-all duration-1000 hover:scale-105">
                <span className="bg-gradient-to-r from-white via-violet-200 to-purple-200 bg-clip-text text-transparent animate-slide-in-left">
                  Bishal Sharma
                </span>
                <span className="text-violet-400 animate-bounce">.</span>
              </h1>
              <div className="relative mb-4">
                <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 animate-slide-in-right transition-all duration-700 hover:text-violet-200">
                  Frontend Developer <span className="text-violet-400 animate-pulse">&</span> UI/UX Enthusiast
                </p>
              ...
              <p className="text-base sm:text-lg text-slate-400 max-w-2xl lg:mx-0 mx-auto mb-8 lg:mb-12 leading-relaxed transform transition-all duration-700 hover:text-slate-300 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start items-center mb-12 lg:mb-16 animate-scale-in">
              ...
              <Button
                onClick={openResume}
                variant="outline"
                className="border-2 border-violet-500/60 text-violet-300 hover:bg-violet-500/20 hover:border-violet-400 px-6 sm:px-8 py-3 rounded-full text-base sm:text-lg w-full sm:w-auto transform transition-all duration-500 hover:scale-110 hover:shadow-lg hover:shadow-violet-500/20 group backdrop-blur-sm"
              >
              ...
              <Button
                ...
                variant="outline"
                className="border-2 border-sky-500/60 text-sky-300 hover:bg-sky-500/20 hover:border-sky-400 px-6 sm:px-8 py-3 rounded-full text-base sm:text-lg w-full sm:w-auto transform transition-all duration-500 hover:scale-110 hover:shadow-lg hover:shadow-sky-500/20 group backdrop-blur-sm"
              >
              ...
              <Button
                ...
                variant="outline"
                className="border-2 border-rose-500/60 text-rose-300 hover:bg-rose-500/20 hover:border-rose-400 px-6 sm:px-8 py-3 rounded-full text-base sm:text-lg w-full sm:w-auto transform transition-all duration-500 hover:scale-110 hover:shadow-lg hover:shadow-rose-500/20 group backdrop-blur-sm"
              >
            ...
            <div className="hidden lg:flex flex-col items-center lg:items-start text-slate-500 animate-fade-in">
              <p className="mb-2 transform transition-all duration-500 hover:text-violet-400">Scroll Down</p>
              <div className="animate-bounce hover:animate-pulse transition-all duration-500 hover:scale-125 hover:text-violet-400 cursor-pointer">
