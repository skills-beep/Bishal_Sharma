...
export function GraduationSection() {
  ...
  return (
    <section id="graduation" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900/40 via-background to-slate-800/20 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-amber-500/30 to-orange-600/30 rounded-full blur-3xl animate-float-slow"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-violet-500/20 to-purple-600/30 rounded-full blur-3xl animate-float-slow-reverse"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-amber-400 via-orange-500 to-rose-400 bg-clip-text text-transparent">
              My Graduation Journey
            </h2>
            <GraduationCap className="w-8 h-8 text-amber-400" />
          </div>
          <div className="w-24 h-1 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 mx-auto rounded-full mb-6"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="order-2 lg:order-1">
            <Card className="bg-slate-900/40 backdrop-blur-xl border-slate-700/50 hover:border-amber-500/40 transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/20">
              <CardHeader>
                    ...
                    {graduationImages.map((image, index) => (
                      <CarouselItem key={index}>
                        <div className="relative group">
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            <Card className="bg-slate-900/40 backdrop-blur-xl border-slate-700/50 hover:border-violet-500/40 transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-violet-500/20">
              ...
              <CardContent className="space-y-6">
                {learnings.map((learning, index) => {
                  ...
                  return (
                    <div key={index} className="flex gap-4 p-4 rounded-lg bg-slate-800/30 hover:bg-slate-700/40 transition-all duration-500 group hover:scale-105 hover:shadow-lg hover:shadow-violet-500/10">
                      <div className={`p-3 rounded-lg bg-slate-800/50 ${learning.color} group-hover:scale-110 transition-all duration-500 group-hover:rotate-6 flex-shrink-0`}>
                        <IconComponent className="w-5 h-5" />
                      </div>
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold text-card-foreground mb-2 group-hover:text-violet-300 transition-colors duration-500">
                          {learning.title}
                        </h4>
                        <p className="text-muted-foreground text-sm leading-relaxed group-hover:text-slate-300 transition-colors duration-300">
            ...
            <Card className="bg-gradient-to-br from-amber-500/20 via-orange-500/20 to-rose-500/20 border-amber-500/40 backdrop-blur-xl hover:scale-105 transition-all duration-700 hover:shadow-2xl hover:shadow-amber-500/30">
              <CardContent className="pt-6">
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/20 border border-amber-500/40 mb-4">
                    ...
                    <span className="text-sm font-medium text-amber-300">University Achievement</span>
                  </div>
        ...
        <div className="text-center mt-16">
          <Card className="max-w-4xl mx-auto bg-gradient-to-br from-slate-900/60 via-slate-800/40 to-slate-900/60 backdrop-blur-xl border-slate-700/50 hover:border-violet-500/40 transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-violet-500/20">
            <CardContent className="pt-8 pb-8">
              <blockquote className="text-lg sm:text-xl italic text-center text-slate-300 leading-relaxed">
              ...
              <cite className="text-sm text-violet-400 font-medium mt-4 block">
